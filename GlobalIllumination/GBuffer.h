...
#define MAX_G_BUFFERS 5
    ...
    GLenum mGBufferFormat[MAX_G_BUFFERS]{ GL_RGBA32F, GL_RGB10_A2, GL_RGBA8, GL_R16F, GL_DEPTH_COMPONENT24 };
    std::string mGBufferNames[MAX_G_BUFFERS]{ "worldpos", "normals", "albedo", "spec", "depth" };
